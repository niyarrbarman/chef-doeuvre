...
# ============================================================================
# ATTRIBUTE-FIRST INFERENCE
# ============================================================================
# torchrun --nproc_per_node=<gpus> --nnodes=<nodes> \
#          --node_rank=0 --master_addr=<ip> --master_port=29500 attr_first.py
# ============================================================================

# ========================= CONFIG =========================
CSV_PATH = "/tmpdir/m25211shrm/musiclm/final-merged-ds.csv"
OUTPUT_PATH = "/tmpdir/m25211shrm/musiclm/deepseek_7b_inference_results_attr_first.csv"
...
# ====================== ATTRIBUTE-FIRST PROMPT ======================
ATTR_FIRST_SYSTEM = """You are a linguistic analyst. Analyze the lyrics by rating these linguistic attributes on a scale of 1-10:
...
def build_prompt(lyrics: str):
    return [
        {"role": "system", "content": ATTR_FIRST_SYSTEM},
...
def process_batch(indices: list, lyrics_list: list) -> list:
    ...
    for i, idx in tqdm(enumerate(indices)):
        ...
        result["reasoning"] = res.get("reasoning", "")
...
print_rank0(f"\n[ATTRIBUTE-FIRST] Starting inference (batch={BATCH_SIZE})...")
...
if RANK == 0:
    ...
    print(f"\n[ATTRIBUTE-FIRST] Saved to {OUTPUT_PATH}")
